...
namespace CarRental.BPO
{
    public class ManageCarsBPO 
    {
        ...
        public static string GetCarsList()
        {
            try
            {
                string query = @"SELECT c_car_id, c_model_name, c_licence_plate, c_type, n_year, n_rate_per_day, n_status, c_image_path FROM dba.car_mst;";
